                        ...
                        <form action="ajouteroccupation.php" method="post">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label">idpatient</label>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <label class="form-label">idchambre</label>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                    <input type="datetime-local" name="date1" id="date1"  value="<?=date('Y-m-d\TH:i')?>"  class="form-control" placeholder="Left Font Awesome Icon"  required>
