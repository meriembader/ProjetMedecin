                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form action="modifieroccupation.php?idoccupation=<?=$occupation['idoccupation']?>" method="post">
                            ...
                            <tr>
            <td>idpatient</td>
            <td><input type='text' name='idpatient'value ="<?php echo $occupation['idpatient'];?>" class='form-control' /></td>
        </tr>
        <tr>
            <td>idchambre</td>
            <td><input type='text' name='idchambre'  value ="<?php echo $occupation['idchambre'];?>"class='form-control' /></td>
        </tr>
        
    
        <tr>
            <td>date</td>
            <td><input type='text' name='date1'value="<?=date('Y-m-d\TH:i')?>"  class='form-control' /></td>
        </tr>

        
     
                                        <button class="btn btn-success waves-effect" type="submit">Valider</button>
                                        <a href='consulteroccupation.php' class='btn btn-danger'>Back</a>
                                </table>
                            </form>
                            <?php if ($msg): ?>
    <p><?=$msg?></p>
